...
export default async function CreateMusicianProfilePage() {
  ...
  return (
    <div className="flex min-h-screen items-start justify-center bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-4xl space-y-8 rounded-lg bg-card p-8 shadow-lg border border-border">
        <div className="text-center">
          <h1 className="mt-6 text-3xl font-extrabold text-foreground">
            Crie seu Perfil de Músico
          </h1>
          <p className="mt-2 text-base text-muted-foreground">
            Compartilhe seus talentos e informações para ser encontrado por contratantes.
          </p>
        </div>
